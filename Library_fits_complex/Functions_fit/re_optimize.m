function vec_fit = re_optimize(vec,vec_st,n_FD,x_data,options)
...
for num = 1:Num_Gaussians_st
    ...
    ub = [1e1*ones(Num_Gaussians_vec,1);1e1*ones(Num_Gaussians_vec,1);2*ones(Num_Gaussians_vec,1);2*ones(Num_Gaussians_vec,1)];
    lb = [-1e1*ones(Num_Gaussians_vec,1);-1e1*ones(Num_Gaussians_vec,1);zeros(Num_Gaussians_vec,1);zeros(Num_Gaussians_vec,1)];
